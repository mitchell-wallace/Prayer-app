<template>
  <section
    class="sticky bottom-0 left-0 right-0 border-t border-[var(--border)] bg-gradient-to-b from-transparent via-[rgba(13,13,16,0.82)] to-[var(--bg)] pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4 backdrop-blur"
  >
